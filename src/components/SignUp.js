  ...
  return (
    <>
      ...
      <div className="flex h-screen bg-slate-800">
        <div className="m-auto bg-slate-700 max-h-[800px] p-5 flex flex-col rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    type="text"
                    id="fname"
                    className="mt-1 border-[1px] border-slate-200 bg-slate-600 rounded-md py-2 px-2 w-full"
                  />
                </div>
                <div>
